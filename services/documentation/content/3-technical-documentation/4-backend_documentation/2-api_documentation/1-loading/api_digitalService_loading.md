...
See the class LoadPhysicalEquipmentMetadataService for an example of the physical equipment loading process.
...
the check tables and digital service data.
...
See the CheckMetadataInventoryFileService  class for an example of the physical equipment coherency checking process.
...
a LoadPhysicalEquipmentService.
...
as 100). This is present in the package apiinout.modeldb as a class public class InPhysicalEquipment.
