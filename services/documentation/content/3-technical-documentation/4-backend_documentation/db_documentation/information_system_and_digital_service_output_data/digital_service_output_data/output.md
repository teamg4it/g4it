...
task{     
  ...
  out_application{     
    ...
    varchar filters     
    varchar filters_physical_equipment     
    varchar filters_virtual_equipment     
    varchar errors     
    int8 count_value     
  ...
  digital_service_version ||--o{ task : "foreign key"
...
| **id**                        |int8||
| *inventory_id*                |int8||
| *digital_service_version_uid* |varchar||
| type                          |varchar||
| status                        |varchar||
