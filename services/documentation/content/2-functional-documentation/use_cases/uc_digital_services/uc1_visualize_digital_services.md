...
| 6         |              |                        | Service Renew Link   | Link     | <li><u>_action rules_</u>: The service renewal link becomes visible 30 days prior to the service expiry date. Clicking on it will open the same popup as described in [Data Retention and Expiry Notice](uc5_extend_the_time.md).                                                                                                                                  |
