...
| 9         |                            | Key indicators                                  |                  | group  | These **key indicators** contextualize the impacts observed and represent the main levers for action to reduce impacts.                                                                                                                                                                                                                                                                        |
...
| 5         |                            | Back to Multi Criteria View         | Particulate matter      | button  | <li><u>_initialization rules_</u>: On Click of this button multi-criteria view will be visible.                                                                         |
