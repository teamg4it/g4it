...
The loading of the files can be completed, completed with errors, failed or failed because of headers depending on the
...
back -->> DataBase: Uploading files into the fileStorage for the chosen inventory
...
front -->> back: GET /subscribers/{subscriber}/organizations/{organization}/inventories/{inventoryId}/output/{batchName}
