...
public class CheckConstraintService {
    ...
    private void checkVirtualEquipmentCoherence(Long taskId, Long inventoryId, String digitalServiceVersionUid,
        ...
        log.info("check virtual equipment validation checkVirtualEquipmentCoherence start for taskId {} and inventoryId {} ", taskId, inventoryId);
        ...
        log.info("checkVirtualEquipmentCoherence ends Time taken: {}s", (endTime - startTime)/1000);
