...
public class TaskTimeoutMonitor {
    ...
    @Value("${g4it.import.timeout.minutes:30}")
     ...
     *
     * @return progress check interval in seconds
     */
    public int getProgressCheckIntervalSeconds() {
        return progressCheckIntervalSeconds;
    }
}
