...
@Component({
    selector: "app-digital-services-ai-infrastructure-side-panel",
    templateUrl: "./digital-services-ai-infrastructure-side-panel.component.html",
    providers: [MessageService],
})
export class DigitalServicesAiInfrastructureSidePanelComponent {
